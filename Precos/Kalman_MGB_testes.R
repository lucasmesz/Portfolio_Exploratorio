...
tstat=est$par/SE
# Display estimates
u1 = cbind(estimate=est$par, SE,tstat)
rownames(u1)=c('sigw','cR1', 'cR2', 'cR3', 'mi','c','r')
colnames(u1)=c('valor estimado','desvio-padrao','estatistica-t')
u1
round(u1,4)
